...
public class ChooseSeatDeluxe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String documentPath = COLLECTION_PATH + databaseItinerary + "/rideDate/" + selectedDate + "/morningTrip/Deluxe";
        ...
        db.document(documentPath).addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot document, @Nullable FirebaseFirestoreException e) {
                if (e != null) {
                    ...
                    Toast.makeText(ChooseSeatDeluxe.this, "Data retrieval failed. Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (document != null && document.exists()) {
                    ...
                    Toast.makeText(ChooseSeatDeluxe.this, "Data retrieval successful!", Toast.LENGTH_SHORT).show();
                } else {
                    // Document doesn't exist or an error occurred while fetching data
                    // Show a toast message indicating data retrieval failure
                    Toast.makeText(ChooseSeatDeluxe.this, "Data retrieval failed.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(ChooseSeatDeluxe.this, "Failed to update seat status.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
        ...
        getSeatStatusFromDatabase(seatId, new ChooseSeat.SeatStatusCallback() {
            ...
            public void onSeatStatusReceived(String seatStatus) {
                if (seatStatus == null) {
                    ...
                    Toast.makeText(ChooseSeatDeluxe.this, "Failed to get seat status. Please try again.", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (seatStatus.equals("1")) {
                    // Seat is taken, notify the user
                    Toast.makeText(ChooseSeatDeluxe.this, "This seat is already taken.", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (selectedSeats.isEmpty()) {
                            ...
                            Toast.makeText(ChooseSeatDeluxe.this, "Please select seats before checking out.", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        ...
                        Intent intent = new Intent(ChooseSeatDeluxe.this, Gcash1.class);
